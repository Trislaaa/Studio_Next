...
export default function StaffBookingsPage() {
    return (
        <Suspense fallback={<div className="p-10 text-center"><div className="w-8 h-8 border-4 border-teal-500 border-t-transparent animate-spin rounded-full mx-auto" /></div>}>
